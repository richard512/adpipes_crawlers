...
class Crawler extends base.Base
  ...
  loginURL : 'http://console.matomymedia.com/index/sign-in'
  IdURL : 'http://console.matomymedia.com/ver/report/get-id'
  GetURL : 'http://console.matomymedia.com/ver/report/get'
  GetVersionURL : 'http://console.matomymedia.com/'
